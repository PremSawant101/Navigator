...
function MenTshirts() {
    ...
    if (loading) {
        return <div className="text-center py-20 tracking-widest">LOADING COLLECTION…</div>;
    }
                ...
                <aside className="filter-sidebar sticky top-28">
                    ...
                    <div className="filter-group">
                        ...
                        <label className="filter-option">
                            <input type="radio" name="sort" value="low-high" checked={sortOrder === "low-high"} onChange={(e) => setSortOrder(e.target.value)} />
                            Low to High
                        </label>
                        <label className="filter-option">
                            <input type="radio" name="sort" value="high-low" checked={sortOrder === "high-low"} onChange={(e) => setSortOrder(e.target.value)} />
                            High to Low
                        </label>
                    </div>
